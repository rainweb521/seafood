                ...
                <div class="item-info">
                    <ul>
                        <li class="post-author hidden-xs">
                            ...
                            <a href="" target="_blank">${row.author.name}</a>
                        </li>
            ...
            <div class="posts-item">
                ...
                <div class="item-info">
                    <ul>
                        ...
                        <li class="ico-cat">
                            <span class=" hidden-xs label label-default  channel_top">价格：<@utils.price/></span>
                            </li>
                        <li class="ico-cat">
                            <span class=" hidden-xs label label-default  channel_top">库存：<@utils.num/></span>
                        </li>
                        <li class="ico-cat"><@utils.showChannel row/></li>
                        <li class="ico-time"><i class="icon-clock"></i>${timeAgo(row.created)}</li>
                        <li class="ico-eye hidden-xs"><i class="icon-book-open"></i>${row.views}</li>
