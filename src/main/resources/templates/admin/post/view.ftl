...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="${base}/admin/post/list">产品管理</a></li>
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            <input type="text" class="form-control" name="title" value="${view.title}" maxlength="64" placeholder="产品标题" required >
                        </div>
                        <div class="form-group">
            ...
            <div class="col-md-3 side-right">
                ...
                <div class="box">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label>价格</label>
                            <input type="text" name="price" class="form-control" value="${view.price}" placeholder="">
                        </div>
                        <div class="form-group">
                            <label>库存</label>
                            <input type="text" name="num" class="form-control" value="${view.num}" placeholder="">
                        </div>
                            <input type="hidden" name="tags" class="form-control" value="" placeholder="">
                    </div>
